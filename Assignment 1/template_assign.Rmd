...
Temperature and humidity seem to be correctly measured
...
According to the computation, 237 is the minimum sample size for a 95% confidence interval for the mean humidity such that the confidence interval has at most length 2% of the mean humidity.
